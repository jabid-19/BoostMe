...
const FAQ = () => {
  return (
    <div className="flex items-center justify-center w-auto mx-6 mb-20 mt-10 lg:h-screen lg:mb-0 2xl:w-[1400px] 2xl:mx-auto">
            ...
            {faqData?.map((faq, index) => (
              <div key={index}>
                <details className="border rounded-lg ">
                  <summary className="px-4 py-6 font-bold">{faq.title}</summary>

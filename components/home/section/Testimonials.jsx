    ...
    <div className="min-h-screen mt-16">
      <div>
        ...
        <div className="flex flex-col flex-wrap gap-x-16 lg:flex-row lg:justify-around lg:items-center">
          <div className="relative mx-auto md:max-w-sm mt-6 min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-3xl border-solid border-4 border-primary">
            <div className="px-6">
                ...
                <div className="flex flex-wrap justify-center">
                  <div className="w-full px-4">
                    <p className=" leading-relaxed text-neutral mb-4">
                      On social, we need to be fast, efficient, and intentional. Boost allows us to
                      be exactly that.
                    </p>

...
export const tabsMenu = [
  ...
  export const Menus = {
    'startPage': [
        ...
        { title: 'Accounts', gap: true, icon: <RiAccountPinBoxLine size={20} />, route: '/dashboard/startPage/accounts'},
        ...
        { title: 'Files', gap: true, icon: <AiOutlineFileSync size={20} />, route: '/dashboard/startPage/files'},
        { title: 'Settings', icon: <FiSettings size={20} />, route: '/dashboard/startPage/settings'},
    ],
    'analytics': [
        { title: 'Home', gap: true, icon: <AiOutlineHome size={20} />, route: '/dashboard/analytics/home'},
        { title: 'Facebook', icon: <FiFacebook size={20} />, route: '/dashboard/analytics/facebook'},
        { title: 'Instagram', icon: <FiInstagram size={20} />, route: '/dashboard/analytics/instagram'},
        ...
        { title: 'Campaigns', gap: true, icon: <BsGraphUp size={20} />, route: '/dashboard/analytics/campaigns'},
        { title: 'Reports', icon: <AiOutlinePieChart size={20} />, route: '/dashboard/analytics/reports' },
    ],
    'inviteYourTeam': [
        { title: 'Calender', icon: <BiCalendar size={20} />, route: '/dashboard/inviteYourTeam/calender'},
        { title: 'Campaign', icon: <BsGraphUp size={20} />, route: '/dashboard/inviteYourTeam/campaign'},
        { title: 'Queues', gap: true, icon: <AiOutlineUnorderedList size={20} />, route: '/dashboard/inviteYourTeam/queues'},
    ],
    'email': [
